...
public interface TweenAccessor<T> {
	 ...
	 * @param tweenType @removed An integer representing the tween type.
	 ...
	 */
	public int getValues(T target, float[] returnValues);
	 ...
	 */
	public void setValues(T target, float[] newValues);
}
