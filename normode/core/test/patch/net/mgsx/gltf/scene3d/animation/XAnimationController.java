package patch.net.mgsx.gltf.scene3d.animation;
 ...
 */
public class XAnimationController extends AnimationController {
	...
	private XModelInstance _target;

	public XAnimationController(XModelInstance target) {
		super(null);
		this._target = target;
	}
	...
	protected void end () {
		...
		transforms.clear();
		if(calculateTransforms) _target.calculateTransforms();
		applying = false;
	}
